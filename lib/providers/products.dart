import 'package:com.agrobs/helpers/app_config.dart';
...
class Products with ChangeNotifier {
  ...
  Future<List<MainProduct>> fetchHomeLatestProducts() async {
    print("This page hasbeen called");
    List<MainProduct> fetchedProducts = [];
    ...
    print(
        "Here is fetch products+++++++++++++++++++++++++++++++++++$fetchedProducts");
    /* for (int i = 0; i < productsConvertedData.length; i++) {
      fetchedProducts.add(Product.fromJson(productsConvertedData[i]));
    }*/
